...
import type { LoginCredentials, AuthResponse, UserBasicInfo } from './types'
...
export const authService = useMock
  ? {
      login: (credentials: LoginCredentials) =>
        loginMock(credentials.email, credentials.password),
      me: meMock,
      logout: logoutMock,
    }
  : {
...
export type { LoginCredentials, AuthResponse, UserBasicInfo }