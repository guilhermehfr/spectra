...
import { Users, UserRound, Lock, Eye, EyeOff, ArrowRight } from 'lucide-react'
      ...
      <Container className="w-full max-w-sm space-y-8">
        <div className="flex flex-col items-center gap-2">
          <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-blue-indigo-100">
            <Users size={25} className="text-blue-600" strokeWidth={2} />
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm text-slate-500 font-normal">Portal familiar</span>
          </div>
        </div>
